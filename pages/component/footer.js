...
export default function footer() {
  return (
    ...
    <div className=' border-t border-white-900 md:p-24 bg-slate-50 md:pb-8'><div className="mx-auto container py-16  xl:px-20 lg:px-12 sm:px-6 px-4  ">
    ...
    />
      ...
      <div className="sm:ml-0 ml-8 flex flex-col">
        <h2 className="text-base font-semibold leading-4 text-gray-800 dark:text-white">Бидний үйлчилгээ</h2>
        <a href="http://localhost:3000/about" className="focus:outline-none  hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-white cursor-pointer">Бидний тухай</a>
        <a href="http://localhost:3000/service" className="focus:outline-none  hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-white cursor-pointer">Үйлчилгээ</a>
     
        <a href="http://localhost:3000/contact" className="focus:outline-none  hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-white cursor-pointer">Холбоо барих</a>
      
      </div>
      <div className="flex flex-col">
        <h2 className="text-base font-semibold leading-4 text-gray-800 dark:text-white">Мэдээ мэдээлэл</h2>
        <a href="#" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-white cursor-pointer">Бидний бодлого</a>
        <a href="#" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-white cursor-pointer">Нөхцөл</a>
    
        <a href="#" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-white cursor-pointer">Зээлийн бодлого </a>
      </div>
      <div className="mt-10 lg:block hidden">
        <label className="text-xl font-medium leading-5 text-gray-800 dark:text-white">Санал хүсэлт</label>
  ...
  <p className=" text-sm leading-none text-gray-800 mt-4 dark:text-white">Copyright © 2022 Том-Амжилт</p>
        <p className="ml-4 text-sm leading-none text-gray-800 mt-4 dark:text-white">All rights reserved</p>
  </div>
