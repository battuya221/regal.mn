...
function Contact({ contact: contact1  }) {
    function sendEmail(e) {
        e.preventDefault();
        external_emailjs_com_default().sendForm("service_2ql6waj", "template_v97hbpl", e.target, "qPLwK4Kr5Xb-xPedU").then((result)=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            " ",
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(layout["default"], {
                children: [
                    contact1.map((contact, index)=>/*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "container mx-auto text-center pt-8",
                        children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                            className: "font-medium ",
                            children: contact1.map((contact, index)=>/*#__PURE__*/ jsx_runtime_.jsx("h1", {
                                    className: "text-slate-700 text-2xl font-semibold md:my-8",
                                    children: contact.contacttitle
                                }, index)
                            )
                        })
                    }),
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        className: "container md:columns-2 mx-auto p-4",
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                className: "container mx-auto lg:flex lg:bg-slate-100 py-12 lg:p-0 lg:m-0 xl:ml-16 lg:mt-0 md:mb-96 md:h-[500px] ",
                                children: [
                                    contact1.map((contact, index)=>/*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                                            className: "ml-24",
                                    ...
                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                children: contact1.map((contact, index)=>/*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                        className: "text-lg font-medium max-w-2xl",
                                                        children: contact.contacdescription
                                                    }, index)
                                                )
                                            }),
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                ...
                                                children: [
                                                    ...
                                                    contact1.map((contact, index)=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                            children: contact.contactphone
                                                        }, index)
                                                    )
                                                ]
                                            }),
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                        children: contact1.map((contact, index)=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                                children: contact.contactaddress
                                                            }, index)
                                                        )
                                                    })
                                                ]
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                ...
                                                children: [
                                                    contact1.map((contact, index)=>/*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                className: "w-full md:w-96 md:max-w-full mx-auto xl:mx-24 pb-12",
                                children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("label", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ jsx_runtime_.jsx("input", {
                                                        ...
                                                        className: "block w-full mt-1 border-gray-300 rounded-md shadow-sm hover:border-indigo-300 hover:ring hover:ring-indigo-200 hover:ring-opacity-50",
                                                        required: true
                                                    })
                                                ]
                                            }),
...
const getServerSideProps = async ()=>{
    const contact = await (0,api/* getAllContactPage */.zn)();
    return {
        props: {
            contact
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [686,675,676,664,438,288,427], () => (__webpack_exec__(1799)));
